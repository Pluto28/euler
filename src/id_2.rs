...
impl Solution for Id2 {
    fn solve() {
        let mut summation = Id2::fact_sum_even(4_000_000);
        println!("{:>30}", format!("Id2 iterative: {}", summation));

        summation = Id2::fact_sum_even_formula(4_000_000);
        println!("{:>30}", format!("Id2 iterative formula: {}", summation));
    }
}
...
mod tests {
    ...
    #[test]
    fn test_up_to_10() {
        assert_eq!(Id2::fact_sum_even(89), 44);
    }

    #[test]
    fn test_up_to_10_rec() {
        assert_eq!(Id2::fact_sum_even_formula(90), 44);
    }
}
